...
client_credentials_manager = SpotifyClientCredentials(client_id="write your client id", client_secret="write your client password")
sp = spotipy.Spotify(client_credentials_manager=client_credentials_manager)

root = tk.Tk()
root.title('Enter your favorite Artist name to help me fetch your desired songs')
root.geometry("900x900")
root.configure(bg='black')
name1 = tk.StringVar()

photo = PhotoImage(file="images/selena_gomez.jpeg")
...
def submit():
    global name
    name = name_entry.get()
    messagebox.showinfo("Information", "Wait for sometime for me to create Playlists")
    root.destroy()
...
message = tk.Label(
    window, text="Smart Music Recommender System",
    bg="yellow", fg="black", width=100,
    height=3, font=('times', 30, 'bold'))

message.place(x=200, y=20)
pred = tk.Button(window, text="Show Songs",
                 command=final, fg="black", bg="white",
                 width=30, height=3, activebackground="Red",
                 font=('times', 15, ' bold '))
pred.place(x=200, y=500)

quitWindow = tk.Button(window, text="Quit",
                       command=window.destroy, fg="black", bg="white",
                       width=20, height=3, activebackground="Red",
                       font=('times', 15, ' bold '))
quitWindow.place(x=1100, y=500)

image1 = Image.open("images/taylor_swift.png")
